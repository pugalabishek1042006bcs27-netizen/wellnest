...
const API_URL = 'https://wellnest-28b1.onrender.com/api/auth'
const PROFILE_API_URL = 'https://wellnest-28b1.onrender.com/api/profile'
const WATER_API_URL = 'https://wellnest-28b1.onrender.com/api/water-intake'
const WORKOUT_API_URL = 'https://wellnest-28b1.onrender.com/api/workouts'
const SLEEP_API_URL = 'https://wellnest-28b1.onrender.com/api/sleep'
const MEAL_API_URL = 'https://wellnest-28b1.onrender.com/api/meals'
const HEALTH_TIP_API_URL = 'https://wellnest-28b1.onrender.com/api/health-tips'
const DIET_PLAN_API_URL = 'https://wellnest-28b1.onrender.com/api/diet-plan'
const WORKOUT_PLAN_API_URL = 'https://wellnest-28b1.onrender.com/api/workout-plan'
const GOALS_API_URL = 'https://wellnest-28b1.onrender.com/api/goals'
const HEALTH_CHAT_API_URL = 'https://wellnest-28b1.onrender.com/api/health-chat'
const FRIENDS_API_URL = 'https://wellnest-28b1.onrender.com/api/friends'
const BLOG_API_URL = 'https://wellnest-28b1.onrender.com/api/blog'
